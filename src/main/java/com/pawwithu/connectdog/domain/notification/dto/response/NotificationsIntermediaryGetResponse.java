...
public record NotificationsIntermediaryGetResponse(Long id, String image, String notificationType,
                                                   String title, String body, Boolean isRead, Long intermediaryId) {

    public NotificationsIntermediaryGetResponse(Long id, String image, NotificationType notificationType,
                                                String title, String body, Boolean isRead, Long intermediaryId) {
