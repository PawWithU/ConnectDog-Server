...
public record ReviewIntermediaryGetOneResponse(String dogName, String volunteerNickname, String mainImage, List<String> images,
    ...
    public ReviewIntermediaryGetOneResponse(String dogName, String volunteerNickname, String mainImage,
    ...
    public static ReviewIntermediaryGetOneResponse of(ReviewIntermediaryGetOneResponse response, List<String> images) {
        return new ReviewIntermediaryGetOneResponse(response.dogName, response.volunteerNickname, response.mainImage, images,
