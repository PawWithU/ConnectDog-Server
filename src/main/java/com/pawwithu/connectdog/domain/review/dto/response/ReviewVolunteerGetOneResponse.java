...
public record ReviewVolunteerGetOneResponse(String dogName, String volunteerNickname, String mainImage, List<String> images,
    ...
    public ReviewVolunteerGetOneResponse(String dogName, String volunteerNickname, String mainImage,
    ...
    public static ReviewVolunteerGetOneResponse of(ReviewVolunteerGetOneResponse response, List<String> images) {
        return new ReviewVolunteerGetOneResponse(response.dogName, response.volunteerNickname, response.mainImage, images,
